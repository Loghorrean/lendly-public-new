...
const FolderIcon = ({ size = SVG_CONTAINER_SIZE.SIZE_48, black, ...props }: Props) => {
    return (
        <SvgContainer size={size}>
            <svg {...props} width="48" height="40" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="27" y="0.200012" width="17.8" height="27" transform="rotate(90 27 0.200012)" fill={black ? "#000" : "#05B768"} />
