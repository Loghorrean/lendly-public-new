...
const CaseIcon = ({ size = SVG_CONTAINER_SIZE.SIZE_48, ...props }: SvgProps) => {
    return (
        <SvgContainer size={size}>
            <svg {...props} width="48" height="39" viewBox="0 0 48 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="41.231" y="14.8923" width="17.2308" height="34.4615" transform="rotate(90 41.231 14.8923)" fill="#05B768"/>
